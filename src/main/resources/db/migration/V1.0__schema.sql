...
TRANSACTION_DATE_FIELD VARCHAR(50) NOT NULL,
TRANSACTION_VALUE_FIELD VARCHAR(50) NOT NULL,
DESCRIPTION_FIELD VARCHAR(50) NOT NULL,
DOCUMENT_ID_FIELD VARCHAR(50)
);
...
CREATE TABLE STATEMENT_CONFIG_CATEGORY (
    ID BIGINT AUTO_INCREMENT  PRIMARY KEY,
...
ALTER TABLE STATEMENT_CONFIG_CATEGORY ADD
FOREIGN KEY ( STATEMENT_CONFIG_ID )
REFERENCES STATEMENT_CONFIG (ID);

ALTER TABLE STATEMENT_CONFIG_CATEGORY
